package com.source.generics;//: generics/WatercolorSets.java
import com.source.generics.watercolors.Watercolors;

import java.util.EnumSet;
import java.util.Set;

import static com.source.generics.watercolors.Watercolors.BRILLIANT_RED;
import static com.source.generics.watercolors.Watercolors.BURNT_UMBER;
import static com.source.generics.watercolors.Watercolors.CERULEAN_BLUE_HUE;
import static com.source.generics.watercolors.Watercolors.VIRIDIAN_HUE;
import static com.source.net.mindview.util.Print.print;
import static com.source.net.mindview.util.Sets.complement;
import static com.source.net.mindview.util.Sets.difference;
import static com.source.net.mindview.util.Sets.intersection;
import static com.source.net.mindview.util.Sets.union;
